...
";
$query = " SELECT * FROM prix WHERE id=1 ";
...
$headers .= "Content-Disposition: inline; filename=\"tarifs.xls\"".$eol;
...
while($row = mysql_fetch_array($mysql_result))
{
	...
	{
mail("webkalortest@gmail.com",stripslashes($objet),$messageHTML, $headers,"application/vnd.ms-excel");
}}
?>